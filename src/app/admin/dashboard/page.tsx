  ...
  useEffect(() => {
    const fetchDashboardStats = async () => {
      try {
        ...
        const [agentsResponse, clientsResponse, productsResponse, followupsResponse] = await Promise.all([
          fetch("https://evershinebackend-2.onrender.com/api/agents"),
          fetch("https://evershinebackend-2.onrender.com/api/clients"),
          fetch("https://evershinebackend-2.onrender.com/api/products"),
          fetch("https://evershinebackend-2.onrender.com/api/followups"),
        ])
    ...
    <div className="flex-1 bg-white">
      <header className="p-6">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <h1 className="text-2xl md:text-3xl font-bold">Welcome, Mr. Ankit</h1>
