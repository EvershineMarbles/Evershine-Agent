        ...
        {filteredProducts.length === 0 ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredProducts.map((product) => (
              <div
                key={product._id}
                className="group relative bg-card rounded-lg overflow-hidden border border-border hover:shadow-md transition-all"
              >
                <div className="p-3">
                  <Link href={`/client-dashboard/${clientId}/product/${product.postId}`}>
                ...
                <div className="p-4">
                  ...
                  <div className="flex justify-between items-center mt-4">
                    <Button
                      ...
                      className={`w-1/2 py-2 rounded-lg text-sm font-medium flex items-center justify-center gap-2
                              ${
                    ...
                    <Button
                      ...
                      className={`w-1/2 py-2 rounded-lg text-sm font-medium flex items-center justify-center gap-2
                              ...
                              transition-colors`}
                      disabled={addingToCart[product.postId]}
                      type="button"
                    >
                      {addingToCart[product.postId] ? (
                        <Loader2 className="h-4 w-4 animate-spin mr-1" />
