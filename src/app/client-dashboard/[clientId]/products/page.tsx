  ...
  const fetchProducts = useCallback(async () => {
    try {
      ...
      if (!response.ok) {
        ...
        console.warn("Agent pricing endpoint failed, falling back to standard endpoint")
          ...
          {filteredProducts.map((product) => (
            ...
            >
              ...
              <div className="p-4">
                ...
                {/* Price display with tooltip if original price is available */}
                {product.originalPrice ? (
                  <TooltipProvider>
                    <Tooltip>
                      ...
                      <TooltipContent>
                        <p>Base price: ₹{product.originalPrice.toLocaleString()}</p>
                        <p>Your commission: ₹{(product.price - product.originalPrice).toLocaleString()}</p>
                      </TooltipContent>
                    </Tooltip>
                  </TooltipProvider>
                ) : (
